  ...
  <div class="w-full max-w-md space-y-8 rounded-lg bg-neutral-800 p-6 shadow-lg">
    ...
    <form class="mt-8 space-y-6" on:submit|preventDefault={handleSignup}>
      <div class="space-y-4 rounded-md">
        <div>
          ...
          <input
            ...
            type="email"
            required
            class="mt-1 block w-full rounded-md border-0 bg-neutral-700 py-1.5 text-white shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6"
        ...
        <div>
          <label for="confirm-password" class="text-sm font-medium text-white"
      ...
      <div class="text-center">
        <a href="/login" class="text-sm text-primary hover:text-red-500">
