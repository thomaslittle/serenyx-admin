...
<div class="min-h-screen bg-white dark:bg-neutral-900">
  <div class="mx-auto max-w-7xl py-8 sm:px-6">
    <div class="mb-8 flex items-center justify-between">
      <h1 class="text-3xl font-bold uppercase text-gray-900 dark:text-white">
      ...
      <div class="space-x-4">
        {#if isEditing}
          ...
          <button
            ...
            class="rounded-md bg-neutral-600 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-500"
          >
            Cancel
          </button>
        {:else}
      ...
      <div class="mb-8 rounded-lg bg-neutral-100 p-4 dark:bg-neutral-800">
        ...
        <div class="space-y-2">
          {#each versions as version}
            <div
              class="flex items-center justify-between rounded-md bg-white p-3 dark:bg-neutral-700"
            >
    ...
    {#if isEditing}
      <div class="rounded-lg bg-neutral-100 p-4 dark:bg-neutral-800">
        <textarea
          ...
          class="h-[800px] w-full resize-none rounded bg-white p-4 font-mono text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-neutral-700 dark:text-white"
        />
      </div>
    {:else}
