	...
	<div class="mx-auto max-w-7xl">
		...
		<div class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
			{#each overlays as overlay}
				<div
					class="group relative rounded-lg bg-gray-800 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-red-500"
				>
					<div>
						<span class="inline-flex rounded-lg bg-red-600 p-3 text-white ring-4 ring-gray-800">
							<!-- Icon placeholder -->
						</span>
					</div>
					<div class="mt-8">
					...
					<div class="mt-4 flex space-x-2">
						<a
							...
							class="inline-flex items-center rounded-md bg-gray-700 px-3 py-2 text-sm font-semibold text-white hover:bg-gray-600"
						>
							Settings
						</a>
						<a
		...
		<!-- Quickstart Guide -->
		<div class="mt-12 rounded-lg bg-gray-800 p-6">
