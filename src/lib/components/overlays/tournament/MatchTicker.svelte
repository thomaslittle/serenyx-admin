...
<div class="fixed bottom-0 left-0 right-0 bg-black bg-opacity-90">
  <div class="relative h-12 overflow-hidden">
    <!-- Red accent line -->
    <div class="absolute left-0 right-0 top-0 h-1 bg-primary"></div>

    <!-- Content -->
    <div class="flex h-full items-center px-4">
      <!-- Time indicator -->
      <div class="flex items-center space-x-2 border-r border-red-600 pr-4 text-primary">
        <Clock class="h-4 w-4" />
        ...
        {#each $matches as match, index}
          ...
          >
            <div class="flex items-center space-x-4">
              ...
              <span class="font-bold text-primary">VS</span>
